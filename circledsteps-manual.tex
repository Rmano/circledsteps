...
\begin{tabular}{>{\ttfamily\textbackslash}ll}
    ...
    CircledText[]\{\} & circled text using the current color (may fail\footnotemark{} across pages break in headers/footers)\\
    \bottomrule
\end{tabular}
...
Math mode is detected too: \Circled{A} and $\Circled{A}$.
\end{LTXexample}
